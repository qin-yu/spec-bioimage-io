...
**CollectionEntry:**
### `collection.i.entry_source`<sub> Optional</sub> ≝ `None`
...
Optional[generic.v0_3.ResourceId]
...
## `id`<sub> Optional[CollectionId]</sub> ≝ `None`
...
## `parent`<sub> Optional[CollectionId]</sub> ≝ `None`
