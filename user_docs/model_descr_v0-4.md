...
(AfterValidator(wo_special_file_name); PlainSerializer(func=<function _package at 0x7f44cfceda80>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
