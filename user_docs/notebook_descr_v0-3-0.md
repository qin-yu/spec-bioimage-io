...
- Path
  (PathType(path_type='file'); Predicate(func=<function PurePath.is_absolute at 0x7f44d2f41940>); WithSuffix(suffix='.ipynb', case_sensitive=True))
...
- _internal.url.HttpUrl
- Path (PathType(path_type='file'); Predicate(func=<function PurePath.is_absolute at 0x7f44d2f41940>))
- _internal.io.RelativeFilePath

(WithSuffix(suffix=('.gif', '.jpeg', '.jpg', '.png', '.svg'), case_sensitive=False); PlainSerializer(func=<function _package at 0x7f44cfceda80>, return_type=PydanticUndefined, when_used='unless-none'))
...
(AfterValidator(_validate_md_suffix); PlainSerializer(func=<function _package at 0x7f44cfceda80>, return_type=PydanticUndefined, when_used='unless-none'))]
...
- Union of
  ...
  (AfterValidator(wo_special_file_name); PlainSerializer(func=<function _package at 0x7f44cfceda80>, return_type=PydanticUndefined, when_used='unless-none'))
