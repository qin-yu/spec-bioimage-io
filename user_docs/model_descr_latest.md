...
Optional[AxisId (Predicate(func=<function <lambda> at 0x7f44c32dd1c0>))]
...
## `timestamp`<sub> _internal.types.Datetime</sub> ≝ `root=datetime.datetime(2024, 3, 20, 20, 44, 40, 844300)`
